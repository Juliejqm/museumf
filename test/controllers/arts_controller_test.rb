...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { author: @art.author, date: @art.date, dimensions: @art.dimensions, photo: @art.photo, theme_id: @art.theme_id, title: @art.title } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { author: @art.author, date: @art.date, dimensions: @art.dimensions, photo: @art.photo, theme_id: @art.theme_id, title: @art.title } }
